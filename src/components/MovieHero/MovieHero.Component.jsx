...
<div className='flex flex-col-reverse gap-3 px-4 my-5'>
...
<div className='flex items-center px-4   gap-2 md:px-4 md:w-screen text-xl'>
  <button className='bg-red-500 text-white rounded-md py-3 px-4 w-full hover:bg-red-600'>Buy ₹200</button>
  <button className='bg-red-500 text-white rounded-md py-3 px-4 w-full hover:bg-red-600'>Rent ₹150 </button>
</div>
</div>
{/* large Screen */}
